from app import db
from models import Projects, ChargeMode, Devices, GSENetwork, PathsLoads, PowerSupply, PowerSupplySummary, TelemetryNetwork, VehicleBattery, VehicleNetwork, UEIDaq, BatteryAddresses, TIDTables, Component
...
def db_init():
    ...
    # testComponent1 = Component(componentName='TestPS1', componentId='1', partNumber='XYZ123', componentType='[PS]', projectId=1)
    # testComponent2 = Component(componentName='TestBattery1', componentId='2', partNumber='ABC123', componentType='[Li-Ion Batt]', projectId=1)
    # testComponent3 = Component(componentName='TestDevice1', componentId='3', partNumber='DEF123', componentType='Device', projectId=1)
    checkNameList = ["[AV Network Switch]", "[Li-Ion Batt]", "[Controller]", "[DAQ-Digital]", "[DAQ-PPC]", "[Flight Computer]", "[GPS]", "[IMU]", "[Network Switch]", "[Ordnance]", "[PC - Server]", "[PDU]", "[Power Control Device]", "[PS]", "[TVC Controller]"]

    # Create Component Table for project 1
    for i, componentName in enumerate(checkNameList):
        testComponent = Component(componentName=componentName, componentId=str(i+10), partNumber='XYZ123', componentType=componentName, projectId=1)
        db.session.add(testComponent)
    ...
    # testComponent4 = Component(componentName='TestPS2', componentId='4', partNumber='XYZ123', componentType='[PS]', projectId=2)
    # testComponent5 = Component(componentName='TestBattery2', componentId='5', partNumber='ABC123', componentType='[Li-Ion Batt]', projectId=2)
    ...
    # testComponent7 = Component(componentName='TestPS3', componentId='7', partNumber='XYZ123', componentType='[PS]', projectId=3)
    # testComponent8 = Component(componentName='TestBattery3', componentId='8', partNumber='ABC123', componentType='[Li-Ion Batt]', projectId=3)
